function frequency = f_RG(D,Gw,Gsyn,ext_stim,time,dt)
% Input explains:
% D1 - descending command from the brain
...
sprops(1,:) = [Gsyn;-40;V_th_low;V_th_high]; 
sprops(2,:) = [Gsyn;-40;V_th_low;V_th_high];
sprops(3,:) = [Gsyn;-70;V_th_low;V_th_high];
sprops(4,:) = [Gsyn;-70;V_th_low;V_th_high]; 
...
[frequency,~] = f_f(nstate(1,:,1),nstate(1,:,2),dt);
end