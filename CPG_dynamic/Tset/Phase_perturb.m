...
% Disturbance D && [511,1511,2511,3511,4511]
% ext_stim ((511 + 10*20):(561+10*20),4) =  - 0.5;
% ext_stim ((511 + 10*40):(561+10*40),4) =  0.5;

% Disturbance G  && [504,1504,2504,3504,4504]
% ext_stim ((504 + 10*20):(554+10*20),4) =  - 0.5;
ext_stim ((504 + 10*40):(554+10*40),4) =  0.5;

%-------------------------------------------------------------------------%
[nstate,~,V_null] = simulate(nstate,nprops,sstate,sprops,conn_map,ext_stim,time,dt); 
% [frequency,step_start] = f_f(nstate(1,:,1),nstate(1,:,2),dt);
EXT = nstate(1,:,1);
FLX = nstate(1,:,2);
...
% figure(1)
% clf
% plot(U_E(511:2511),'r','Linewidth',2)
% hold on
% plot(EXT(511:2511),'r--','Linewidth',2)
% hold off
% 
% xlim([0 2000])
...
figure(2)
clf
plot(U_E(504:2504),'r','Linewidth',2)
hold on
plot(EXT(504:2504),'r--','Linewidth',2)
hold off
