function nstate = f_TLC (D,Gw,Gc,G_syn,PF_G,ext_stim,time,dt)
...
sprops(9,:) = [PF_G;-40;V_th_low;V_th_high];
sprops(10,:) = [PF_G;-40;V_th_low;V_th_high];
sprops(11,:) = [PF_G;-70;V_th_low;V_th_high];
sprops(12,:) = [PF_G;-70;V_th_low;V_th_high]; %<---- PF
