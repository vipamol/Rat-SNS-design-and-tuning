function [ v_star_low, v_star_high, v_star_interneuron_inh, v_star_interneuron_exc, nprops, sprops ] = RG_find_inhibited_V_ss( values, vars_to_change, nprops, sprops )
