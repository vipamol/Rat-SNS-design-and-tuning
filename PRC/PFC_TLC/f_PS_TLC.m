function PS = f_PS_TLC (D,Gw,Gc,G_syn,G,ext_stim,time,dt)
...
[RG_frequency,RG_ss] = ff(nstate(1,:,1),nstate(1,:,2),dt); % RG
[PF_frequency,PF_ss] = ff(nstate(1,:,5),nstate(1,:,6),dt); % PF

if PF_frequency == RG_frequency
    PS = PF_ss-RG_ss;
else
    PS = [];
end
