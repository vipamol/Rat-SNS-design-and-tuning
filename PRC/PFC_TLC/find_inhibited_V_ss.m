function [ v_star_low, v_star_high, v_star_interneuron_inh, v_star_interneuron_exc, nprops, sprops ] = find_inhibited_V_ss( values, vars_to_change, nprops, sprops )
...
%     num_synapses = size(sprops,1);
    ...
    E_hyp = sprops(3,2);
    g = @(v) dV_dt(v,hinf_of_v(nprops(2,9),nprops(2,10),nprops(2,11),v),G_hyp,E_hyp,nprops(2,:));
