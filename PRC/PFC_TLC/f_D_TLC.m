function frequency = f_D_TLC (D,DP,Gw,Gc,G_syn,G,ext_stim,time,dt)
...
% [frequency,~] = ff(nstate(1,:,1),nstate(1,:,2),dt); % RG
[frequency,~] = ff(nstate(1,:,5),nstate(1,:,6),dt); % PF
% plot(nstate(1,:,5));hold on;plot(nstate(1,:,6));
end